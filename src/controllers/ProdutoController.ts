...
export async function cadastrarProduto(
  dadosParametros: string,
): Promise<retornoRequisicaoProps> {
  return instanciaAxios
    .post<retornoRequisicaoProps>('produto/cadastrar', dadosParametros)
    .then(({ data }) => {
      return data
    })
    .catch((error) => {
...
export async function alterarProduto(
  ...
  return instanciaAxios
    .put<retornoRequisicaoProps>('produto/alterar', dadosParametros)
    .then(({ data }) => {
      return data
    })
    .catch((error) => {
...
export async function buscarListaCodigoBarrasProduto(
  tokenProduto: string,
): Promise<codigoBarrasProps[]> {
  return instanciaAxios
    .get<codigoBarrasProps[]>('produto/codigo_barras/listar', {
      params: {
        tokenProduto,
      },
    })
...
export async function adicionarNovoCodigoBarrasProduto(
  tokenProduto: string,
  codigoBarras: string,
): Promise<retornoRequisicaoProps> {
  return instanciaAxios
    .post<retornoRequisicaoProps>('produto/codigo_barras/adicionar', {
      tokenProduto,
...
export async function deletarCodigoBarrasProduto(
  tokenCodigoBarras: string,
): Promise<retornoRequisicaoProps> {
  return instanciaAxios
    .delete<retornoRequisicaoProps>('produto/codigo_barras/remover', {
      data: {
...
export async function buscarListaHistoricoEstoque(
  dataInicio: string | null,
  dataFim: string | null,
): Promise<historicoEstoqueEmpresaProps[]> {
  return instanciaAxios
    .get('estoque/historico/todos', {
      params: {
        dataInicio,
        dataFim,
      },
...
export async function buscarListaHistoricoProduto(
  pro_id: string,
): Promise<historicoProdutoEstoqueProps[]> {
  return instanciaAxios
    .get('estoque/historico/produto', {
      params: {
        tokenProduto: pro_id,
      },
    })
